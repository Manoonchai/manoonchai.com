...
const FaqPage: NextPage = () => {
  return (
    <section className="text-center py-20 mx-16">
      <NextSeo title="คำถามที่พบบ่อย" />

      <h1 className="text-3xl font-bold sm:text-6xl">คำถามที่พบบ่อย</h1>

      <div className="text-left">
        <Question question="หลักการของการสร้างแป้นพิมพ์มนูญชัยคืออะไร?">
          <a
        ...
        >
          <div>
            <h2 className="text-2xl font-bold my-4">
              ต้องมาเรียนใหม่ จำใหม่อีกแล้วหรือ?
            </h2>
            <p className="text-gray-400">
              สบายใจได้! คุณยังสามารถใช้แป้นพิมพ์เดิมได้อยู่
              หากคุณพบว่าแป้นพิมพ์ของคุณกลายร่างเป็นแป้นพิมพ์มนูญชัยโดยไม่ทราบสาเหตุ
              โปรดติดต่อเราโดยด่วนได้
              <a
                className="underline text-gray-600"
                href="https://bit.ly/3kjtSYL"
              >
                ที่นี่
              </a>
            </p>
          ...
          <div className="mt-8">
            <a
              ...
              rel="noreferrer"
            >
              หากมีข้อสงสัยเพิ่มเติม สามารถเข้ามาถามในคอมมูนิตี้ Discord ได้
            </a>
          </div>
        </Question>
      </div>
